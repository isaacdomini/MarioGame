cp MarioGame/Theming/Scenes/Level1.json MarioGame/bin/Windows/x86/Debug/Level1.json
cp MarioGame/Theming/Scenes/HiddenLevel.json MarioGame/bin/Windows/x86/Debug/HiddenLevel.json
cp MarioGame/Theming/Scenes/Level2.json MarioGame/bin/Windows/x86/Debug/Level2.json
