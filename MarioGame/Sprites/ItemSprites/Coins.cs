...
{
    public class Coins : AnimatedSprite //TODO: refactor this class to use either ANimated Sprite or Sprite
    {
        ...
        public Coins(IEntity entity, ContentManager content, Viewport viewport) : base(entity, content, viewport)
        {
