...
{
    public class MushroomSuper : AnimatedSprite //TODO: refactor this class to use either ANimated Sprite or Sprite
    {
        ...
        public MushroomSuper(IEntity entity, ContentManager content, Viewport viewport) : base(entity, content, viewport)
        {
