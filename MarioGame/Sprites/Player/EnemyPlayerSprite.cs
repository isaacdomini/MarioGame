...
{
    public class EnemyPlayerSprite : HidableSprite
    {
        private enum Frames
        {
        ...
        public EnemyPlayerSprite(ContentManager content, Entity entity) : base(content, entity)
        {
            AssetName = "regulargoomba";
        }
        
        public void ChangeActionState(EnemyPlayerActionState enemyActionState)
        {
            FrameSet = FrameSets[enemyActionState.EnemyState.GetHashCode()];
            FrameSetPosition = 0;
        }
    }
}
